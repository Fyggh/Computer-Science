 ...
 *
 */
public abstract class AardvarkOld {
	 ...
	 * 
	 */
	protected AardvarkOld(int x, int y) {
	...
	public static class Cartoon extends AardvarkOld {
		...
		final static Color AARDVARK_YELLOW = new Color(255, 213, 29);
		final static Color AARDVARK_BLUE = new Color(0, 93, 171);
